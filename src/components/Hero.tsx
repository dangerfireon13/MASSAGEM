...
const Hero: React.FC = () => {
  return (
    <section className="pt-20 pb-10 px-4 flex flex-col items-center text-center bg-black min-h-[90vh] relative overflow-hidden">
      ...
      <div className="w-full max-w-[320px] md:max-w-[400px] mb-12 relative group z-10">
        <div className="absolute -inset-4 bg-red-600/20 blur-3xl rounded-3xl animate-pulse"></div>
        <div className="relative w-full bg-stone-950 rounded-2xl overflow-hidden border-2 border-red-600 shadow-[0_0_60px_rgba(220,38,38,0.4)]">
          <wistia-player media-id="bitqorpg5r" aspect="0.8"></wistia-player>
        </div>
      </div>
