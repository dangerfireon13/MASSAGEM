...
const AmandaSection: React.FC = () => {
  const fullContent = [
    ...
    },
    {
      ...
      items: ["+130 Aulas", "Comunidade Secreta", "Mapas Erógenos", "Suporte com Amanda"]
    }
  ];
  ...
  const amandaImageUrl = "https://scontent.fcgh55-1.fna.fbcdn.net/v/t39.30808-6/593997222_789812600764626_8703064354453394793_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=1d70fc&_nc_ohc=QPFCs5z8ziMQ7kNvwGwZ50u&_nc_oc=Adn59pB2FF37flXH9sUvRX8kpCgYOy1u_XFO5mAabDZyJ8--Lw_mq3Ih1iRwgN_alDGWUPrvOxmPS72PNhtsHM8I&_nc_zt=23&_nc_ht=scontent.fcgh55-1.fna&_nc_gid=-Ra4yB6is9SdOTIGY54bqA&oh=00_AfvoQ5o0DF10HLf6_5fyGY0jOK-GkOnc_mpPyUuLnZVvWQ&oe=699E7A0F";
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-16 bg-stone-900/10 p-6 rounded-[3rem] border border-red-900/10">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl md:text-3xl font-black text-white uppercase italic mb-3">
              CONHEÇA A <span className="text-red-600">AMANDA</span>
            </h2>
